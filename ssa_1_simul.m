...
%% Run simulation
[t,x,x2] = directMethod(stoich_matrix, pfun, tspan, x0, p);
%% Plot time course
figure();
hold on
...
yyaxis right
h2 = stairs(t,x2, ':'); set(gca,'XLim',tspan);
xlabel('time (s)');
...
lgd.FontSize = 14;
title('Single Stochastic Simulation and Differential Model')
end
