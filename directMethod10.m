function [ t, x, x2 ] = directMethod10( stoich_matrix, propensity_fcn, tspan, x0,...
                                  params, output_fcn, MAX_OUTPUT_LENGTH)

if ~exist('MAX_OUTPUT_LENGTH','var')
    MAX_OUTPUT_LENGTH = 6000000;
end
...
while T(rxn_count) < tspan(2)        
    ...
    a0 = sum(a);
    r = rand(1,2);
    tau = (-log(r(1))/a0)/10; %(1/a0)*log(1/r(1));
    ...
    X(rxn_count+1,:) = X(rxn_count,:) + stoich_matrix(mu,:)/10;    
